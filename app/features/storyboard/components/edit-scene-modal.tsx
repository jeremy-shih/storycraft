...
import { Scene, ImagePrompt, VideoPrompt, Scenario } from "@/app/types";
...
export function EditSceneModal({
    ...
    const updateImagePrompt = <K extends keyof ImagePrompt>(
        field: K,
        value: ImagePrompt[K],
    ) => {
        setEditedScene((prev) => ({
    ...
    const updateImagePromptComposition = (
        field: keyof ImagePrompt["Composition"],
        value: string,
    ) => {
        setEditedScene((prev) => ({
            ...prev,
    ...
    const updateImagePromptSubjects = (selectedCharacterNames: string[]) => {
        ...
        const validCharacterNames = selectedCharacterNames.filter(
            (name) => name && name.trim() !== "",
        );
    ...
    const updateImagePromptProps = (selectedPropNames: string[]) => {
        ...
        const validPropNames = selectedPropNames.filter(
            (name) => name && name.trim() !== "",
        );
    ...
    const getSelectedCharacterNames = (): string[] => {
        return (
            editedScene.imagePrompt.Subject?.map(
    ...
    const getSelectedPropNames = (): string[] => {
        return (
            editedScene.imagePrompt.Prop?.map((prop) => prop.name).filter(
                (name) => name && name.trim() !== "",
            ) || []
        );
    };
    ...
    const updateImagePromptContext = (selectedSettingName: string) => {
        ...
        const setting = scenario.settings.find(
    ...
    const getSelectedSettingName = (): string => {
        return editedScene.imagePrompt.Context.length > 0
    ...
    const updateVideoPrompt = <K extends keyof VideoPrompt>(
        field: K,
        value: VideoPrompt[K],
    ) => {
        setEditedScene((prev) => ({
    ...
    const updateVideoPromptDialogue = (
        index: number,
        field: "speaker" | "line",
        value: string,
    ) => {
    ...
    const removeVideoPromptDialogue = (index: number) => {
        setEditedScene((prev) => ({
            ...
            videoPrompt: {
                ...prev.videoPrompt,
                Dialogue: prev.videoPrompt.Dialogue.filter(
                    (_, i) => i !== index,
                ),
            },
        }));
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="ml-4 grid grid-cols-1 gap-3 md:grid-cols-3">
                                            <div>
                                                ...
                                                <Input
                                                    value={
                                                        editedScene.imagePrompt
                                                            .Composition
                                                            .shot_type
                                                    }
                                                    onChange={(e) =>
                                                        updateImagePromptComposition(
                                                            "shot_type",
                                                            e.target.value,
                                                        )
                                                    }
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <MultiSelect
                                            options={scenario.characters.map(
                                                (character) => ({
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Textarea
                                            value={
                                                editedScene.videoPrompt.Action
                                            }
                                            onChange={(e) =>
                                                updateVideoPrompt(
                                                    "Action",
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {editedScene.videoPrompt.Dialogue.map(
                                            (dialogue, index) => (
                                                <div
                                                    key={index}
